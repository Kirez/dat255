...
public class Regulator {
  ...
  /**
   * Instantiates all variables. Easy to change the different parameters, for
   * example max speed or desired distance to object in front.
   */
  public Regulator() {
  ...
  /**
   * Simple return method, casts v1 to an integer.
   *
